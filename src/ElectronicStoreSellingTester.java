public class ElectronicStoreSellingTester extends ElectronicStoreStockTester{
  public static void main(String[] args){
    ...
    System.out.println(String.format("%s's total revenue was: $%.2f", store1.getName(), store1.getRevenue()));
    System.out.println(String.format("%s's total revenue was: $%.2f", store2.getName(), store2.getRevenue()));
    System.out.println(String.format("%s's total revenue was: $%.2f", store3.getName(), store3.getRevenue()));
  }
}